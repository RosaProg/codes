...
$CFG->dbhost    = '166.62.94.48';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'vsstechn_mood2';     // database name, eg moodle
$CFG->dbuser    = 'vsstechn_mood2';   // your database username
$CFG->dbpass    = 'U^#2L(zNIaG0zD[kB[(74*(4';   // your database password
...
$CFG->wwwroot   = 'http://localhost/vidyanta'; //http://vidyanta.vsstechnology.com
...
$CFG->dataroot  = 'C:\xampp\htdocs\vidyanta\data'; ///home/vsstechnology/public_html/vidyanta/data
...
//           'dbhost' => 'localhost',
//           'dbname' => 'moodletest',
//           'dbuser' => 'vsstechn_mood2',
//           'dbpass' => 'vsstechn_mood2',
//           'behat_prefix' => 'mood_',
