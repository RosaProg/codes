class ApplicationController < ActionController::Base
  ...
  META_DESCRIPTION = " enables the public to commission journalists to do investigations on important and perhaps overlooked stories. " + 
  ...
  def block_ips
    ...
    return head(:bad_request) if ['wiki.','w3.'].include?(request.domain)
  end
  ...
  def html_meta_tags(meta_description = META_DESCRIPTION, meta_keywords = META_KEYWORDS)
     @meta_description = " Community Report: " + strip_html(meta_description)[0..180] if meta_description and !meta_description.blank?
