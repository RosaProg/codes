...
class Purchase < ActiveRecord::Base
  ...
  attr_accessor :credit_card_number, :credit_card_year, :credit_card_month,
    :credit_card_type, :verification_value, :donation_amount, :_donation_amount
  attr_reader :credit_card

  cattr_accessor :gateway

  after_create :associate_donations, :associate__donations, :associate_credits
  ...
  def donations_sum
    ...
    amount += _donation[:amount] unless _donation.nil? || _donation[:amount].nil?
    amount
  end
  ...
  def associate__donations
    user.unpaid__donation.update_attribute(:purchase_id, self.id) if user.unpaid__donation
  end
