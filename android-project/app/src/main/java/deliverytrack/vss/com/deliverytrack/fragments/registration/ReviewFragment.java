...
import deliverytrack.vss.com.deliverytrack.models.ReviewItem;
...
public class ReviewFragment extends ListFragment implements ModelCallbacks {
    ...
    public void onPageDataChanged(Page changedPage) {
        ...
        for (Page page : mWizardModel.getCurrentPageSequence()) {
            page.getReviewItems(reviewItems, getActivity());
        }
    ...
    private class ReviewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup container) {
            ...
            if (TextUtils.isEmpty(value)) {
                ((TextView) rootView.findViewById(android.R.id.text2)).setTextColor(Color.RED);
